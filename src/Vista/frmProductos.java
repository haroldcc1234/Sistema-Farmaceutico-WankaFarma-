...
//VALIDAR CAMPOS PARA QUE TODOS ESTEN LLENOS
        //--------------------------------------------------
        if (txtDescripcion.getText().isEmpty()  || txtStock.getText().isEmpty() || txtPresentacion.getText().isEmpty()
            || txtCosto.getText().isEmpty() || txtPrecio.getText().isEmpty() || txtConcentracion.getText().isEmpty() ) {
            ...
            if (num == 0) {
                int respuesta = metodos.guardarProductos(Descripcion, Concentracion, Stock, Costo, Precio, fecha, Estado, Presentacion, Laboratorio);
                if (respuesta > 0) {
                    listar();
                ...
                int respuesta = metodos.ActualizarDatos(ID, Descripcion, Concentracion, Stock, Costo, Precio, fecha, Estado, Presentacion, Laboratorio);
                if (respuesta > 0) {
                    listar();
                    num = 0;
                }
